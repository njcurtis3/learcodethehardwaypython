...
print "(-4, 6):" + str(p.feed_forward([-4,6,1]))
print "(8, 3):" + str(p.feed_forward([8,3,1]))
print "(3, 2)" + str(p.feed_forward([3,2,1]))
print "(-6, 1)" + str(p.feed_forward([-6,1,1]))
print "(-12, -12)" + str(p.feed_forward([-12,-12,1]))
